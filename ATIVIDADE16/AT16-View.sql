...
SELECT COUNT(PrimeiroNome) FROM Funcionarios
WHERE Salario > 4000
AND CPF IS NOT NULL;
...
WHERE UltimoNome = 'Oliveira'
OR SegundoNome = 'Oliveira';
-- 12
SELECT * FROM Funcionarios;
...
SELECT COUNT(Codigo) FROM Funcionarios
WHERE SegundoNome = 'Almeida'
OR UltimoNome = 'Almeida'
OR Salario < 3500;
